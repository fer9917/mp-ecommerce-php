<?php
    ...
    $preference->back_urls = array(
        "success" => "https://".$_SERVER['SERVER_NAME']."/success.php",
        "failure" => "https://".$_SERVER['SERVER_NAME']."/error.php",
        "pending" => "https://".$_SERVER['SERVER_NAME']."/pending.php"
    );
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    ...
                                    <a class="mercadopago-button" style="padding: 15px;" href="<?php echo $preference->init_point; ?>">Pagar la compra</a>
                                </div>
                            </div>
                        </div>
                    </div>
