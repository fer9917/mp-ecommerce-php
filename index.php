                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            ...
                                            <input type="hidden" name="description" value="Smartphone Galaxy S9 con multiples cámaras y velocidad de procesamiento">
                                ...
                                <div class="as-producttile large-4 small-6 group-1">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            ...
                                            <input type="hidden" name="unit" value="1">
                                            <input type="hidden" name="description" value="Smartphone LG 6 con multiples cámaras y velocidad de procesamiento">
                                            <button type="submit" class="mercadopago-button" formmethod="post">Comprar</button>
                                        </form>
                                    </div>
                                </div>
                                <div class="as-producttile large-4 small-6 group-1">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            ...
                                            <input type="hidden" name="unit" value="1">
                                            <input type="hidden" name="description" value="Smartphone Iphone 8 con multiples cámaras y velocidad de procesamiento">
                                            <button type="submit" class="mercadopago-button" formmethod="post">Comprar</button>
                                        </form>
                                    </div>
                                </div>
                                <div class="as-producttile large-4 small-6 group-2">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            ...
                                            <input type="hidden" name="unit" value="1">
                                            <input type="hidden" name="description" value="Smartphone Motorola G5 con multiples cámaras y velocidad de procesamiento">
                                            <button type="submit" class="mercadopago-button" formmethod="post">Comprar</button>
                                        </form>
                                    </div>
                                </div>
                                <div class="as-producttile large-4 small-6 group-2">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            ...
                                            <input type="hidden" name="unit" value="1">
                                            <input type="hidden" name="description" value="Smartphone Moto G4 con multiples cámaras y velocidad de procesamiento">
                                            <button type="submit" class="mercadopago-button" formmethod="post">Comprar</button>
                                        </form>
                                    </div>
                                </div>
                                <div class="as-producttile large-4 small-6 group-2">
                                    ...
                                    <div class="as-producttile-info" style="min-height: 168px;">
                                        ...
                                        <form action="/detail.php" method="get">
                                            ...
                                            <input type="hidden" name="price" value="10000">
                                            <input type="hidden" name="unit" value="1">
                                            <input type="hidden" name="description" value="Smartphone Xperia con multiples cámaras y velocidad de procesamiento">
                                            <button type="submit" class="mercadopago-button" formmethod="post">Comprar</button>
                                        </form>
                                    </div>
                                </div>
